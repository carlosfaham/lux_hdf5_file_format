...
def load_evt_file(hdf5_filename):
    ...
    # Get settings
    evt_settings = load_attributes_recursive(f['/evt_settings'])
    daq_settings = load_attributes_recursive(f['/daq_settings'])
    trigger_settings = load_attributes_recursive(f['/trigger_settings'])

    settings = {'evt_settings':evt_settings,'daq_settings':daq_settings,'trigger_settings':trigger_settings}
...
def load_livetime(f):
    ...
    livetime['livetime_latch_samples'] = livetime_group['latch_samples'][...]
    livetime['livetime_end_samples'] = livetime_group['end_samples'][...]
